<template>
  <div class="bg-green-50/50 dark:bg-neutral-900/50">
    <UContainer class="pb-24 md:pb-0 flex gap-4">
      ...
      <!-- Navegación móvil -->
      <section class="fixed z-50 inset-x-0 bottom-4 w-full px-4 md:hidden">
        <UCard class="dark:border-primary-500 w-full shadow-md dark:border" :ui="{ body: 'p-0 sm:p-0 px-2' }">
          <MobileNav />
        </UCard>
      </section>
