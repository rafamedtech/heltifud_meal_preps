...
<template>
  <main class="flex min-h-full flex-col space-y-6">
    ...
    <UCard
      class="flex-1 overflow-hidden rounded-xl border border-default/70 bg-default/95 shadow-sm"
      ...
      >
        <div class="max-w-md space-y-3 text-center">
          ...
          <div class="space-y-1">
            ...
            <p class="text-sm text-muted">Ajusta la búsqueda o cambia el filtro para volver a ver platillos.</p>
          </div>
        </div>
      </section>
