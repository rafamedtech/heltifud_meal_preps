import { _ as __nuxt_component_0, s as steps, m as menuItems, b as benefits, a as faqQuestions } from './helpers-DvbKa16t.mjs';
import { u as useSeoMeta, z as __nuxt_component_1, q as _sfc_main$a, a as useAppConfig, b as useComponentUI, t as tv } from './server.mjs';
import { _ as _sfc_main$4 } from './Separator-wL2r3kyL.mjs';
import { _ as __nuxt_component_3 } from './Section-DrncyQpB.mjs';
import { _ as _sfc_main$5 } from './Carousel-DXpkVikY.mjs';
import { _ as __nuxt_component_5 } from './Card-CG1tUrfr.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</section></div><figure class="aspect-8/11 w-full max-w-100 overflow-hidden border border-primary-500 shadow-2xl md:ml-14">`);
      ...
      _push(ssrRenderComponent(_component_BaseSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<figure class="flex w-full max-w-110 items-center justify-center overflow-hidden"${_scopeId}>`);
            ...
            return [
              createVNode("figure", { class: "flex w-full max-w-110 items-center justify-center overflow-hidden" }, [
      ...
      _push(ssrRenderComponent(_component_BaseSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<figure class="flex aspect-8/11 w-full max-w-100 items-center justify-center overflow-hidden"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtImg, {
            ...
            return [
              createVNode("figure", { class: "flex aspect-8/11 w-full max-w-100 items-center justify-center overflow-hidden" }, [
                createVNode(_component_NuxtImg, {
                  src: "v1746204411/heltifud/promo_hbku0g.png",
                  width: "400",
                  height: "550",
...
//# sourceMappingURL=index-Bz8DCDEG.mjs.map
