import { c as _export_sfc, Q as useState, P as __nuxt_component_0$2, e as _sfc_main$g, _ as _sfc_main$a, u as useRoute, b as useToast, n as navigateTo } from './server.mjs';
...
import { d as adminLinks, l as links } from './helpers-W5IJF87J.mjs';
import { a as __nuxt_component_3, _ as _sfc_main$1$1 } from './ColorMode-DPRaW54j.mjs';
import { _ as _sfc_main$5 } from './Modal-DHNNY9I2.mjs';
import { _ as _sfc_main$6 } from './Alert-DmPqFZyZ.mjs';
import { u as useSupabaseClient } from './useSupabaseClient-COavZuE6.mjs';
import { _ as _sfc_main$4 } from './Card-BsgwMRuG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-shell h-dvh min-h-dvh overflow-hidden bg-neutral-50 text-highlighted dark:bg-neutral-950" }, _attrs))} data-v-df81c23b><div class="flex h-full w-full" data-v-df81c23b><aside class="${ssrRenderClass([unref(sidebarWidthClass), "app-sidebar hidden h-full shrink-0 transition-[width] duration-200 md:flex md:flex-col"])}" data-v-df81c23b><div class="app-sidebar-header relative flex min-h-20 items-center px-4 py-3" data-v-df81c23b><div class="relative flex w-full flex-col items-center gap-3 xl:hidden" data-v-df81c23b>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/admin",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex size-9 items-center justify-center rounded-xl bg-primary/8 text-primary" data-v-df81c23b${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
      ...
      if (unref(isSidebarCollapsed)) {
        _push(`<div class="relative hidden w-full flex-col items-center gap-3 xl:flex" data-v-df81c23b>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/admin",
          class: "flex items-center justify-center rounded-xl"
        }, {
        ...
        _push(`<div class="relative hidden w-full items-center xl:flex" data-v-df81c23b>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/admin",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex size-7 items-center justify-center rounded-lg bg-primary/8 text-primary" data-v-df81c23b${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "i-heroicons-squares-2x2",
                class: "size-4"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="min-w-0" data-v-df81c23b${_scopeId}><p class="truncate text-sm font-semibold text-highlighted" data-v-df81c23b${_scopeId}>Heltifud Admin</p><p class="truncate text-[11px] text-muted" data-v-df81c23b${_scopeId}>Operación interna</p></div>`);
            } else {
              return [
      ...
      _push(`</div><div class="admin-scrollbar flex min-h-0 flex-1 flex-col overflow-y-auto py-4 px-4 xl:hidden" data-v-df81c23b>`);
      _push(ssrRenderComponent(_component_AdminNavigationMenu, { collapsed: "" }, null, _parent));
      _push(`</div><div class="hidden min-h-0 flex-1 xl:block" data-v-df81c23b>`);
      if (unref(isSidebarCollapsed)) {
        _push(`<div class="admin-scrollbar min-h-0 h-full flex-1 flex-col overflow-y-auto py-4 px-4" data-v-df81c23b>`);
        _push(ssrRenderComponent(_component_AdminNavigationMenu, { collapsed: "" }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="admin-scrollbar min-h-0 h-full flex-1 flex-col overflow-y-auto py-4 px-4" data-v-df81c23b>`);
      ...
      _push(`</div><div class="app-sidebar-footer py-4 px-4 xl:hidden" data-v-df81c23b><div class="flex w-full justify-center" data-v-df81c23b>`);
      _push(ssrRenderComponent(_component_ColorMode, { compact: "" }, null, _parent));
      _push(`</div></div><div class="app-sidebar-footer hidden py-4 px-4 xl:block" data-v-df81c23b>`);
      if (unref(isSidebarCollapsed)) {
        _push(`<div class="flex flex-col items-center gap-3" data-v-df81c23b><div class="flex w-full justify-center" data-v-df81c23b>`);
        _push(ssrRenderComponent(_component_ColorMode, { compact: "" }, null, _parent));
        _push(`</div><div class="flex w-full justify-center" data-v-df81c23b>`);
        _push(ssrRenderComponent(_component_UButton, {
          square: "",
          size: "sm",
          variant: "ghost",
        ...
        _push(`<div class="flex flex-col items-stretch gap-3" data-v-df81c23b>`);
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-df81c23b${_scopeId}>Colapsar</span>`);
            } else {
              return [
      ...
      _push(`</div></aside><main class="flex min-w-0 flex-1 flex-col overflow-hidden" data-v-df81c23b><div class="h-24 border-b border-default/70 bg-default/70 px-4 backdrop-blur-xl md:px-8" data-v-df81c23b><div class="mx-auto flex w-full max-w-[1600px] items-center justify-between gap-3" data-v-df81c23b><section class="min-w-0 flex-1" data-v-df81c23b>`);
      _push(ssrRenderComponent(_component_AdminHeader, { collapsed: unref(isSidebarCollapsed) }, null, _parent));
      _push(`</section></div></div><section class="admin-scrollbar min-h-0 flex-1 overflow-y-auto [scrollbar-gutter:stable] px-4 py-6 pb-24 md:px-8 md:pb-8" data-v-df81c23b><div class="mx-auto w-full max-w-[1600px]" data-v-df81c23b>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></section></main></div><section class="fixed inset-x-0 bottom-4 z-50 px-4 md:hidden" data-v-df81c23b>`);
...
const admin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-df81c23b"]]);
